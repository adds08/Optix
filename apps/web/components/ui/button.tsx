...
const buttonVariants = cva(
  /* `active:scale-[0.98]` is the web press feedback (docs/20, F) — a button
     ...
     Blocky (ADR-7): 3px radius, semibold, flat — no shadows on controls. */
  "motion-safe:active:scale-[0.98] inline-flex shrink-0 items-center justify-center gap-2 rounded-sm text-sm font-semibold whitespace-nowrap transition-all outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
